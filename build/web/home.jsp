...
<html lang="en">
    ...
    <body>
            ...
            <ul class="slides-container">
                <li class="text-center">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>Welcome To <br> Laptop Gaming Store</strong></h1>
                                <p class="m-b-40">Enjoy your times here with us <br> to find the suitable laptop for your studying</p>
                            </div>
                        </div>
                    </div>
                </li>
        ...
        <div class="categories-shop">
            <div class="container">
                <div class="row">
                    <c:forEach var="o" items="${top3list}">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="shop-cat-box">
                                <img style="width: 23rem; height: 26rem;" class="img-fluid" src="${o.image}" alt="" />
                                <a class="btn hvr-hover" href="#">${o.name}</a>
                            </div>
                        </div>
                    </c:forEach>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="title-all text-center">
                            ...
                            <p>Buy your computer with affordable price</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-3 col-md-6 special-grid best-seller">
                            <div class="products-single fix">
                                <div class="box-img-hover">
                                    ...
                                    <div class="mask-icon">
                                        <a class="cart" href="href="MainController?action=Add&pid=${o.id}&quantity=1">Add to Cart</a>
                                    </div>
                                </div>
                                <div class="why-text">
                                    <h4>${o.name}</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            <div class="footer-widget">
                                <h4>About Latop Gaming Store</h4>
